...
import NaturalOriginContentOfCosmeticProducts.accounts.managers
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            managers=[
                ('objects', NaturalOriginContentOfCosmeticProducts.accounts.managers.NaturalOriginAccountManager()),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company_logo', models.URLField(blank=True, null=True, verbose_name='company website')),
                ('company', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
